        ...
        if (stillInToolPhase) {
            ...
            return (
                <div className="flex justify-start mb-4">
                    <div className="bg-white/5 rounded-2xl rounded-bl-md px-4 py-3 border border-[#333]/80 flex items-center gap-3">
                        <div className="flex items-end gap-[3px]">
                            <span className="w-[3px] rounded-full bg-cyan-400 animate-[bounce_1s_ease-in-out_infinite] [animation-delay:0ms]" style={{height: '10px'}} />
                            <span className="w-[3px] rounded-full bg-cyan-400 animate-[bounce_1s_ease-in-out_infinite] [animation-delay:150ms]" style={{height: '14px'}} />
                            <span className="w-[3px] rounded-full bg-cyan-400 animate-[bounce_1s_ease-in-out_infinite] [animation-delay:300ms]" style={{height: '10px'}} />
                        </div>
                                ...
                                {isSending && agentStatus && streamingContent && (
                                    <div className="flex items-center gap-2 text-gray-500 mb-4">
                                        <div className="bg-[#161616]/70 rounded-xl px-3 py-2 border border-[#262626]">
                                            <span className="text-xs">{displayedStatus || agentStatus}</span>
                                        </div>
                                    </div>
                                )}
